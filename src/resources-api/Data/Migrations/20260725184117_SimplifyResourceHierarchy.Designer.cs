...
namespace resources_api.Data.Migrations
{
    ...
    [Migration("20260725184117_SimplifyResourceHierarchy")]
    partial class SimplifyResourceHierarchy
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("resources_api.Models.Resource", b =>
                {
                    ...
                    b.HasIndex("PageVersionId", "NormalizedName");
            ...
            modelBuilder.Entity("resources_api.Models.ResourceVersion", b =>
                {
                    ...
                    b.Property<string>("ActiveLanguageCode")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasMaxLength(20)
                        .HasColumnType("varchar(20)")
                        .HasComputedColumnSql("CASE WHEN IsDeleted = 0 THEN LanguageCode ELSE NULL END", true);
                    ...
                    b.HasIndex("ResourceId", "ActiveLanguageCode")
                        .IsUnique();
